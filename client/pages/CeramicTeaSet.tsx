...
// Mock product data for Ceramic Tea Set
const mockProductData = {
  ...
  images: [
    "/ceramic-tea-set.jpg",
    "/ceramic-tea-set-2.jpg",
    "/ceramic-tea-set-3.jpg",
    "/ceramic-tea-set-4.jpg"
  ],
  rating: 5,
  reviews: 18,
  price: 156,
  ...
  shortDescription: "Elegant ceramic tea set with traditional glazing techniques",
  description: `
    <h3>Artisan Ceramic Tea Set</h3>
    
    <p>This exquisite ceramic tea set represents the perfect blend of traditional pottery techniques and contemporary design. Each piece is handcrafted by Marcus Rivera using methods passed down through generations of ceramic artists.</p>
    
    <h4>Materials & Construction</h4>
    <p>Made from high-quality stoneware clay sourced from local deposits, this tea set features a beautiful celadon glaze that creates a subtle, elegant finish. The clay is fired at high temperatures to ensure durability and food safety.</p>
    
    <h4>The Story Behind the Craft</h4>
    <p>Marcus learned pottery from his grandfather in Santa Fe, New Mexico. Each tea set takes approximately 20 hours to complete, including throwing, trimming, glazing, and firing. The traditional celadon glaze technique dates back to ancient Chinese pottery.</p>
    
    <h4>Care Instructions</h4>
    <p>Hand wash with mild soap and warm water. Microwave and dishwasher safe. Store in a dry place away from direct sunlight.</p>
  `,
  inStock: true,
  stockCount: 2,
  artisanInfo: {
    ...
    memberSince: "2018",
    specialties: ["Ceramic Pottery", "Traditional Glazing", "Stoneware"],
    bio: "Marcus is a master ceramic artist specializing in traditional pottery techniques. His work focuses on functional art that brings beauty to everyday life.",
    avatar: "/artist2.avif",
    productsCount: 18,
    rating: 4.8,
  },
  features: [
    ...
    "Traditional Celadon Glaze",
    "Microwave & Dishwasher Safe",
    "Food Safe & Lead Free",
    "Includes Teapot & 4 Cups",
  ],
  dimensions: 'Teapot: 8" x 6" x 4", Cups: 3" x 3" x 2.5"',
...
const relatedProducts = [
  ...
  },
  {
    ...
    artisan: "Marcus Rivera",
    image: "/ceramic-tea-set-4.jpg",
    price: 120,
    rating: 5,
  },
];

export default function CeramicTeaSet() {
  const { id } = useParams();
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  High-quality stoneware clay with traditional celadon glaze
                </p>
              </div>
            </div>
          </TabsContent>
