...
// Mock product data for Leather Journal
const mockProductData = {
  ...
  images: [
    "/leather-journal.jpg",
    "/leather-journal-2.jpg",
    "/leather-journal-3.jpg",
    "/leather-journal-4.jpg"
  ],
  rating: 4,
  reviews: 31,
  price: 65,
  ...
  shortDescription: "Hand-bound leather journal with handmade paper",
  description: `
    <h3>Artisan Leather Journal</h3>
    
    <p>This exquisite leather journal is a testament to traditional bookbinding craftsmanship. Each journal is handcrafted by Sofia Andersson using techniques that have been perfected over centuries of leatherworking tradition.</p>
    
    <h4>Materials & Construction</h4>
    <p>Made from premium vegetable-tanned leather sourced from ethical tanneries, this journal features hand-stitched binding and acid-free handmade paper. The leather develops a beautiful patina over time, making each journal unique to its owner.</p>
    
    <h4>The Story Behind the Craft</h4>
    <p>Sofia learned leatherworking from her father in Stockholm, Sweden. Each journal takes approximately 8 hours to complete, including cutting, stitching, and finishing. The traditional saddle-stitch binding ensures the journal will last for generations.</p>
    
    <h4>Care Instructions</h4>
    <p>Keep away from direct sunlight and moisture. Clean with a soft cloth and leather conditioner. The leather will naturally develop character with use.</p>
  `,
  inStock: true,
  stockCount: 5,
  artisanInfo: {
    ...
    memberSince: "2020",
    specialties: ["Leatherworking", "Bookbinding", "Traditional Craftsmanship"],
    bio: "Sofia is a master leatherworker specializing in traditional bookbinding techniques. Her work focuses on creating functional art that ages beautifully.",
    avatar: "/artist3.avif",
    productsCount: 31,
    rating: 4.7,
  },
  ...
  dimensions: '5.8" x 8.3" x 0.8" (A5 size)',
  weight: "12 oz (340g)",
  shippingInfo: {
    freeShipping: false,
...
const relatedProducts = [
  ...
  },
  {
    ...
    artisan: "Sofia Andersson",
    image: "/leather-journal-4.jpg",
    price: 35,
    rating: 4,
  },
];

export default function LeatherJournal() {
  const { id } = useParams();
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Premium vegetable-tanned leather with acid-free handmade paper
                </p>
              </div>
            </div>
          </TabsContent>
