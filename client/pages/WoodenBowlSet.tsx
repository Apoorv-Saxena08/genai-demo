...
// Mock product data for Wooden Bowl Set
const mockProductData = {
  ...
  images: [
    "/wooden-bowl-set.jpg",
    "/wooden-bowl-set-2.jpg",
    "/wooden-bowl-set-3.jpg",
    "/wooden-bowl-set-4.jpg"
  ],
  rating: 5,
  reviews: 12,
  price: 120,
  ...
  shortDescription: "Hand-carved wooden bowls from sustainable oak",
  description: `
    <h3>Artisan Wooden Bowl Set</h3>
    
    <p>This exquisite wooden bowl set represents the perfect fusion of traditional woodworking craftsmanship and modern design. Each bowl is hand-carved by David Park using techniques passed down through generations of woodworkers.</p>
    
    <h4>Materials & Construction</h4>
    <p>Made from sustainably sourced oak wood, each bowl is carefully carved using traditional hand tools. The wood is naturally finished with food-safe oils that enhance the grain and provide protection. Each bowl is unique due to the natural variations in the wood grain.</p>
    
    <h4>The Story Behind the Craft</h4>
    <p>David learned woodworking from his grandfather in rural Oregon. Each bowl set takes approximately 25 hours to complete, including selecting the wood, rough carving, fine carving, sanding, and finishing. The traditional carving techniques ensure each piece is truly one-of-a-kind.</p>
    
    <h4>Care Instructions</h4>
    <p>Hand wash with mild soap and warm water. Re-oil periodically with food-safe mineral oil. Store in a dry place away from direct sunlight and extreme temperatures.</p>
  `,
  inStock: true,
  stockCount: 1,
  artisanInfo: {
    ...
    memberSince: "2019",
    specialties: ["Woodworking", "Traditional Carving", "Sustainable Materials"],
    bio: "David is a master woodworker specializing in traditional carving techniques. His work focuses on creating functional art that brings warmth and beauty to everyday life.",
    avatar: "/artist1.avif",
    productsCount: 15,
    rating: 4.9,
  },
  features: [
    "Hand-carved from Sustainable Oak",
    "Food-safe Natural Oil Finish",
    "Set of 3 Nested Bowls",
    "Each Bowl is Unique",
    "Traditional Carving Techniques",
  ],
  dimensions: 'Large: 8" diameter x 3" height, Medium: 6" diameter x 2.5" height, Small: 4" diameter x 2" height',
  weight: "2 lbs (0.9kg)",
  shippingInfo: {
    freeShipping: true,
...
const relatedProducts = [
  ...
  },
  {
    ...
    artisan: "David Park",
    image: "/wooden-bowl-set-4.jpg",
    price: 45,
    rating: 5,
  },
];

export default function WoodenBowlSet() {
  const { id } = useParams();
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Sustainably sourced oak wood with food-safe natural oil finish
                </p>
              </div>
            </div>
          </TabsContent>
