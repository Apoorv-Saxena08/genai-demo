...
// Mock product data for Glass Pendant Necklace
const mockProductData = {
  ...
  images: [
    "/glass-pendant-necklace.jpg",
    "/glass-pendant-necklace-2.jpg",
    "/glass-pendant-necklace-3.jpg",
    "/glass-pendant-necklace-4.jpg"
  ],
  rating: 4,
  reviews: 27,
  price: 85,
  ...
  shortDescription: "Handblown glass pendant with sterling silver chain",
  description: `
    <h3>Artisan Glass Pendant Necklace</h3>
    
    <p>This stunning glass pendant necklace is a masterpiece of glassblowing artistry. Each pendant is handcrafted by Luna Martinez using traditional glassblowing techniques that create unique, one-of-a-kind pieces.</p>
    
    <h4>Materials & Construction</h4>
    <p>Made from high-quality borosilicate glass, each pendant is handblown and shaped using traditional techniques. The pendant is suspended from a sterling silver chain, creating a beautiful contrast between the delicate glass and the elegant metal.</p>
    
    <h4>The Story Behind the Craft</h4>
    <p>Luna learned glassblowing from her mentor in Venice, Italy. Each pendant takes approximately 3 hours to complete, including gathering the glass, shaping, cooling, and finishing. The traditional Venetian glassblowing techniques ensure each piece is truly unique.</p>
    
    <h4>Care Instructions</h4>
    <p>Store in a soft cloth or jewelry box to prevent scratches. Clean gently with a soft cloth and mild soap. Avoid exposure to extreme temperatures and harsh chemicals.</p>
  `,
  inStock: true,
  stockCount: 4,
  artisanInfo: {
    ...
    memberSince: "2021",
    specialties: ["Glassblowing", "Jewelry Design", "Traditional Venetian Techniques"],
    bio: "Luna is a master glassblower specializing in traditional Venetian techniques. Her work focuses on creating wearable art that captures the beauty and fragility of glass.",
    avatar: "/artist2.avif",
    productsCount: 22,
    rating: 4.8,
  },
  features: [
    ...
    "Traditional Venetian Techniques",
    "Adjustable Chain Length",
  ],
  dimensions: 'Pendant: 1.5" x 1" x 0.5", Chain: 18" with 2" extension',
  weight: "0.5 oz (14g)",
  shippingInfo: {
    freeShipping: false,
...
const relatedProducts = [
  {
    id: 10,
    name: "Glass Bead Earrings",
    artisan: "Luna Martinez",
    image: "/glass-pendant-necklace-2.jpg",
    price: 55,
    rating: 4,
  },
  {
    id: 11,
    name: "Murano Glass Bracelet",
    artisan: "Luna Martinez",
    image: "/glass-pendant-necklace-3.jpg",
    price: 75,
    rating: 5,
  },
  {
    ...
    name: "Glass Ring Set",
    artisan: "Luna Martinez",
    image: "/glass-pendant-necklace-4.jpg",
    price: 65,
    rating: 4,
  },
];

export default function GlassPendantNecklace() {
  const { id } = useParams();
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <p className="text-muted-foreground">
                  Borosilicate glass pendant with sterling silver chain
                </p>
              </div>
            </div>
          </TabsContent>
